...
namespace Logging.ThriftContract
{
  public partial class LogTransferService {
    public interface Iface {
      void Log(TMsg msg);
      #if SILVERLIGHT
      IAsyncResult Begin_Log(AsyncCallback callback, object state, TMsg msg);
    ...
    public class Client : IDisposable, Iface {
      ...
      #if SILVERLIGHT
      public IAsyncResult Begin_Log(AsyncCallback callback, object state, TMsg msg)
      {
        return send_Log(callback, state, msg);
      }
      ...
      public void Log(TMsg msg)
      {
        ...
        #else
        var asyncResult = Begin_Log(null, null, msg);
        End_Log(asyncResult);

        #endif
      }
      #if SILVERLIGHT
      public IAsyncResult send_Log(AsyncCallback callback, object state, TMsg msg)
      #else
      public void send_Log(TMsg msg)
      #endif
      {
